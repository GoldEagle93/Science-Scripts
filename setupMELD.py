...
def setup_system():
    ...
    rest = make_cartesian_collections(s, const_scaler, range(1,16),atoms=["C1'","C2","C2'","C3'","C4","C4'","C5","C5'","C6","C7","C8","DA3","N1","N2","N3","N4","N6","N7","N9","O2","O3'","O4","O4'","O5'","O6","OP1","OP2","P"])
    ...
    dom1 = get_dist_restraints('proteinDNA_contacts_all.dat',s,scaler= dist_scaler)
    s.restraints.add_selectively_active_collection(dom1,20)
    ...
    scaler3 = s.restraints.create_scaler('nonlinear',alpha_min=0.7,alpha_max=1.0, factor=4.0, strength_at_alpha_min=0.0, strength_at_alpha_max=1.0)
    ...
    for j in non_gly:
        group2.append( (j,"CB") )
    positioner = s.restraints.create_scaler('linear_positioner',alpha_min=0.7, alpha_max=1.0, pos_min=1., pos_max=7.) 
    conf_rest.append(s.restraints.create_restraint('com', scaler3,ramp=LinearRamp(0,100,0,1), 
                                                       force_const=50.0,group1=group1,group2=group2,
